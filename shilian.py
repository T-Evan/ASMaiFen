    ...
    def elong(self):
        ...
        while 1:
            if elapsed > totalWait:
                ...
                teamStatus1 = ocrFindRangeClick('匹配中')
    ...
    def changeMap(self, selectMap, selectStage):
        ...
        if selectMap not in maps_to_check:
            ...
            if res:
                ...
                sleep(2)
        res = ocrFindRangeClick(selectMap, 1, 0.8, 12, 160, 282, 1171)
